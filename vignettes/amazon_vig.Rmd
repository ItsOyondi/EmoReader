...
The count_emotions function provides the frequency of each of the emotions with the frequency table. The function ask for the parameter to be passed and we have passed our emo_mat parameter which consists of the 10 different emotion that has been generated from each reviews. 
...
8. https://zdebruine.github.io/singlet/articles/Guided_Clustering_with_NMF.html
